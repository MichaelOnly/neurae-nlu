...
config = AutoConfig.from_pretrained("bhadresh-savani/electra-base-emotion", label2id=label2id, id2label=id2label)

model = ElectraForSequenceClassification.from_pretrained(
    "bhadresh-savani/electra-base-emotion", config=config, ignore_mismatched_sizes=True)

wandb.init(project="nlu embeddings", name="electra")
