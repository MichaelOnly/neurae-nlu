...
config = AutoConfig.from_pretrained("textattack/albert-base-v2-imdb", label2id=label2id, id2label=id2label)

model = AlbertForSequenceClassification.from_pretrained(
    "textattack/albert-base-v2-imdb", config=config, ignore_mismatched_sizes=True)

wandb.init(project="nlu embeddings", name="albert")
...
training_args = TrainingArguments(
    ...
    logging_dir='./models/albert/logs',
    logging_steps=100,
