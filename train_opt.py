...
config = AutoConfig.from_pretrained("ArthurZ/opt-350m-dummy-sc", label2id=label2id, id2label=id2label)

model = OPTForSequenceClassification.from_pretrained(
    "ArthurZ/opt-350m-dummy-sc", config=config, ignore_mismatched_sizes=True)

wandb.init(project="nlu embeddings", name="opt")
